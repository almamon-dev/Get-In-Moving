            ...
            <div className="space-y-6 max-w-8xl mx-auto pb-20">
                    ...
                    <div className="relative bg-[#f4f0ff] rounded-[12px] p-6 border border-[#e9e3ff] overflow-hidden flex items-center justify-between">
                        <div className="flex-1">
                            ...
                            <p className="text-[14px] text-[#727586]">
                                Track customer activity, verification status,
                                and manage accounts from one place.
                            </p>
                        </div>
                        <div className="flex items-center gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-[12px] border border-[#e3e4e8] p-6 shadow-sm">
                        <div className="text-[13px] font-medium text-[#727586] uppercase tracking-wider">
                            Total Customers
                        </div>
                        <div className="mt-2 text-[32px] font-bold text-[#2f3344]">
                            {stats.total}
                        </div>
                    </div>
                    <div className="bg-white rounded-[12px] border border-[#e3e4e8] p-6 shadow-sm">
                        ...
                        <div className="mt-2 text-[32px] font-bold text-[#00b090]">
                            {stats.verified}
                        </div>
                    </div>
                    <div className="bg-white rounded-[12px] border border-[#e3e4e8] p-6 shadow-sm">
                        ...
                        <div className="mt-2 text-[32px] font-bold text-[#ffb000]">
                            {stats.unverified}
                        </div>
                    </div>
                </div>
