...
export default function Edit({ auth, pricingPlan }) {
    const [formData, setFormData] = useState({
        ...
        user_type: pricingPlan.user_type || 'customer',
            ...
            <div className="min-h-screen bg-[#fafbfc]">
                <div className="max-w-8xl mx-auto px-6 py-8">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            <h1 className="text-[28px] font-bold text-[#2f3344]">Edit Pricing Plan</h1>
                            <p className="text-[14px] text-[#727586]">Update {pricingPlan.name} plan details</p>
                        </div>
                    </div>
